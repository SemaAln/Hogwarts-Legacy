...
public abstract class Spell {
	...
	public Spell(String name, int manaCost, MagicLevel levelNeeded) {
		...
		if (manaCost < 0) {
			throw new IllegalArgumentException("manaCost cannot be negati");
		}

		if (levelNeeded == null) {
			throw new IllegalArgumentException("levelneeded cannot be null");
		}
	...
	public void cast(MagicSource source, MagicEffectRealization target) {
		if (source == null || target == null) {
			throw new IllegalArgumentException("source &target canot be null");
		}
